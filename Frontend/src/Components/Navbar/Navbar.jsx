    ...
    <div className="NavbarDiv">
          ...
          >
            ...
            <Flex alignItems={"center"} gap={"30px"}>
              <Link to={"/signup"}>
                <Button
                  _hover={"none"}
                  style={secondBtn ? { padding: "5px", height: "30px", border: "none" }: { padding: "5px", fontSize:"20px", border: "none",color:"white" }}
                  variant="outline"
                >
      ...
      <div className="headss">
        ...
        <div className="headingAB">
          <h4>
            Trusted by 80 million Travelers, Alcazar is the world's most
